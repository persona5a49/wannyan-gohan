...
const FOODS = [
  {name:'ニュートロ シュプレモ シニア犬用', maker:'Nutro', kcal:350, protein:26, fat:13, priceKg:1827, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'3kg袋基準', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['senior','coat','balanced','small'], mainProtein:'チキン', fiber:4.0, url:'https://hb.afl.rakuten.co.jp/ichiba/57b41c22.08fe12c0.57b41c23.755a6e9f/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fnyanzaq%2F4562358781827%2F&link_type=hybrid_url&ut=eyJwYW...c2V9'},
  {name:'ヒルズ サイエンス・ダイエット シニア 小型犬用', maker:'Hill’s', kcal:365, protein:19, fat:14, priceKg:1420, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['senior','small','cost','balanced'], mainProtein:'チキン', fiber:2.3, url:'https://hb.afl.rakuten.co.jp/ichiba/57b41d3d.0196a071.57b41d3e.22d83eeb/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fsweet-pet%2F118579662%2F&link_type=picttext&ut=eyJwYW...NlfQ%3D%3D'},
  {name:'ロイヤルカナン ミニ エイジング12+', maker:'Royal Canin', kcal:385, protein:24, fat:12, priceKg:1505, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'複数容量展開の代表販売サイズ基準', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['senior','small','palatable'], mainProtein:'チキン', fiber:2.5, url:'https://hb.afl.rakuten.co.jp/ichiba/57b41e37.7d60f1c7.57b41e38.dcb0788f/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2F1096dog%2Fw-120005-00-00%2F&link_type=picttext&ut=eyJwYW...NlfQ%3D%3D'},
  {name:'アカナ シニアドッグ', maker:'ACANA', kcal:332, protein:33, fat:14, priceKg:2300, priceUnverified:true, priceBasis:'estimated', packageSize:'', checkedAt:'', priceSourceUrl:'', priceNote:'価格未確認のため販売ページ確認', tags:['senior','protein','weight'], mainProtein:'チキン', fiber:6, url:'https://px.a8.net/svt/ejp?a8mat=4BCFNK+3I7X0Y+5FPU+5YJRM'},
  {name:'ピュリナ ワン 7歳以上 ほぐし粒入り', maker:'Purina', kcal:360, protein:27, fat:13, priceKg:1194, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['senior','cost','palatable'], mainProtein:'チキン', fiber:4.5, url:'https://hb.afl.rakuten.co.jp/ichiba/57b41f4a.7a14458b.57b41f4b.35feaa3c/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fbadasai%2F4902201206563%2F&link_type=picttext&ut=eyJwYW...NlfQ%3D%3D'},
  {name:'このこのごはん', maker:'オモヤ', kcal:343, protein:20.9, fat:8.2, priceKg:5230, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['small','lowfat','japan','coat'], mainProtein:'チキン', url:'https://hb.afl.rakuten.co.jp/ichiba/57b796b2.783134fe.57b796b9.ae291207/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fkonokototomoni%2Fkonoko-01%2F&link_type=picttext&ut=eyJwYW...NlfQ%3D%3D'},
  {name:'モグワン ドッグフード', maker:'レティシアン', kcal:361, protein:27, fat:10, priceKg:2600, priceUnverified:true, priceBasis:'estimated', packageSize:'1.8kg袋（販売ページ確認）', checkedAt:'', priceSourceUrl:'', priceNote:'価格未確認のため販売ページ確認', tags:['balanced','palatable','coat'], mainProtein:'チキン', fiber:4.75, url:'https://px.a8.net/svt/ejp?a8mat=4BCFNK+2SMA0I+3J8+1HKDAR&a8ejpredirect=https%3A%2F%2Fwww.mogwandogfood.co.jp%2F7700%2F'},
  {name:'犬猫生活 ドッグフード シニア', maker:'犬猫生活', kcal:338, protein:26, fat:9, priceKg:5987, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['senior','japan','lowfat'], mainProtein:'チキン', fiber:3, url:'https://hb.afl.rakuten.co.jp/ichiba/57b797c2.9582bd06.57b797c3.18668413/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Finuneko-seikatsu%2Fdog_sr_chi_sma%2F&link_type=picttext&ut=eyJwYW...NlfQ%3D%3D'},
  {name:'セレクトバランス エイジングケア チキン', maker:'Select Balance', kcal:325, protein:20, fat:10, priceKg:1687, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['senior','lowfat','cost','small'], mainProtein:'チキン', fiber:5.5, kibbleSize:'小粒', url:'https://hb.afl.rakuten.co.jp/ichiba/57b41f84.bf4f5b64.57b41f85.19f72c13/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fvetschoice%2F4541851006200%2F&link_type=picttext&ut=eyJwYW...NlfQ%3D%3D'},
  {name:'プロマネージ 7歳からの室内犬用', maker:'PROMANAGE', kcal:375, protein:22, fat:14, priceKg:1208, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['senior','cost','small'], mainProtein:'チキン', fiber:5.0, url:'https://hb.afl.rakuten.co.jp/ichiba/57b41c22.08fe12c0.57b41c23.755a6e9f/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fnyanzaq%2F81211%2F&link_type=picttext&ut=eyJwYW...NlfQ%3D%3D'},
  {name:'アイムス 7歳以上 健康サポート', maker:'IAMS', kcal:365, protein:24, fat:11, priceKg:749, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['senior','cost'], mainProtein:'チキン', fiber:4.0, url:'https://hb.afl.rakuten.co.jp/ichiba/57b5a5f6.8d9dfb7c.57b5a5f7.4393bfe4/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fthinkrich%2Fsk09926%2F&link_type=picttext&ut=eyJwYW...NlfQ%3D%3D'},
  {name:'ユーカヌバ シニア 小型犬用', maker:'Eukanuba', kcal:401, protein:27, fat:15, priceKg:1068, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['senior','small','palatable'], mainProtein:'チキン', fiber:2.7, url:'https://hb.afl.rakuten.co.jp/ichiba/57b41e37.7d60f1c7.57b41e38.dcb0788f/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2F1096dog%2Fw-162060-00-00%2F&link_type=picttext&ut=eyJwYW...NlfQ%3D%3D'},
  {name:'ナウフレッシュ スモールブリード シニア', maker:'NOW FRESH', kcal:341, protein:24, fat:12, priceKg:3037, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['senior','small','grainfree','weight'], mainProtein:'ターキー', fiber:5.5, url:'https://hb.afl.rakuten.co.jp/ichiba/57b79ceb.e7a018b7.57b79cec.f9af103e/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fdogparadise%2F4573160559030%2F&link_type=picttext&ut=eyJwYW...NlfQ%3D%3D'},
  {name:'オリジン シニア', maker:'ORIJEN', kcal:371, protein:38, fat:15, priceKg:3200, priceUnverified:true, priceBasis:'estimated', packageSize:'', checkedAt:'', priceSourceUrl:'', priceNote:'価格未確認のため販売ページ確認', tags:['senior','protein','ingredient'], mainProtein:'チキン', fiber:6, url:'https://px.a8.net/svt/ejp?a8mat=4BCFNK+3I7X0Y+5FPU+5YRHE'},
  {name:'ソルビダ グレインフリー チキン 室内飼育7歳以上', maker:'SOLVIDA', kcal:350, protein:25, fat:15, priceKg:3129, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['senior','grainfree','lowfat','coat'], mainProtein:'チキン', fiber:6, url:'https://hb.afl.rakuten.co.jp/ichiba/57b41f84.bf4f5b64.57b41f85.19f72c13/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fvetschoice%2F4562312014527%2F&link_type=picttext&ut=eyJwYW...NlfQ%3D%3D'},
  {name:'アーテミス アガリクス I/S 小粒', maker:'Artemis', kcal:358, protein:24, fat:14, priceKg:1907, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['small','stomach','palatable'], mainProtein:'チキン', fiber:4.0, kibbleSize:'小粒', url:'https://hb.afl.rakuten.co.jp/ichiba/57b79ceb.e7a018b7.57b79cec.f9af103e/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fdogparadise%2F8133690054908%2F&link_type=picttext&ut=eyJwYW...NlfQ%3D%3D'},
  {name:'ナチュロル', maker:'楽しい製薬', kcal:400, protein:23, fat:10, priceKg:3882, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['japan','palatable','ingredient'], url:'https://reason-why.jp/naturol/se/'},
  {name:'馬肉自然づくり', maker:'健康いぬ生活', kcal:399, protein:27, fat:11, priceKg:3300, priceUnverified:true, priceBasis:'estimated', packageSize:'', checkedAt:'', priceSourceUrl:'', priceNote:'価格未確認のため販売ページ確認', tags:['japan','palatable','ingredient'], mainProtein:'馬肉', fiber:5.2, url:'https://px.a8.net/svt/ejp?a8mat=4BCFNK+2PN3ZM+3E6W+TR13N&a8ejpredirect=http%3A%2F%2Fkenko-dog.com%2Flp%2Fbanikushizendukuri-teiki%2F'},
  {name:'Yum Yum Yum! シニア&ライト チキン', maker:'GREEN DOG', kcal:320, protein:20, fat:8.5, priceKg:3838, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['senior','japan','lowfat','weight','small'], mainProtein:'チキン', url:'https://hb.afl.rakuten.co.jp/ichiba/57bd8fda.8dbe604e.57bd8fdb.677d0384/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fpetoukokupremium%2F6554%2F&link_type=picttext&ut=eyJwYW...NlfQ%3D%3D'},
  ...
  {name:'ブッチ ブラック・レーベル', maker:'Butch', kcal:116, protein:10.5, fat:8, priceKg:2063, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['wet','palatable','senior'], mainProtein:'ビーフ', fiber:1.0, url:'https://butch-japan.co.jp/products/blacklabel800'},
  ...
  {name:'ロイヤルカナン ミニ ライトウェイトケア', maker:'Royal Canin', kcal:323, protein:28, fat:9, priceKg:1674, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['weight','small','lowfat'], mainProtein:'チキン', url:'https://hb.afl.rakuten.co.jp/ichiba/57b5a3b9.ecf57661.57b5a3ba.8d1f18b9/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fdog-penet%2Ff11225%2F&link_type=picttext&ut=eyJwYW...NlfQ%3D%3D'},
  {name:'ヒルズ サイエンス・ダイエット 減量サポート 小型犬用', maker:'Hill’s', kcal:313, protein:24, fat:9, priceKg:1280, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['weight','small','lowfat','cost'], url:'https://hb.afl.rakuten.co.jp/ichiba/57b41d3d.0196a071.57b41d3e.22d83eeb/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fsweet-pet%2Fset0096s%2F&link_type=picttext&ut=eyJwYW...NlfQ%3D%3D'},
  {name:'VetSolution 犬用 胃腸サポート', maker:'Monge', kcal:383, protein:24, fat:15, priceKg:3516, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['stomach','senior'], url:'https://hb.afl.rakuten.co.jp/ichiba/57b84b87.2ec97563.57b84b88.333718c7/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fvetslabo%2Fdr000114%2F&link_type=picttext&ut=eyJwYW...NlfQ%3D%3D'},
  {name:'ロイヤルカナン サイズヘルス ニュートリション ミニ パピー', maker:'Royal Canin', kcal:408, protein:28.5, fat:18, priceKg:1785, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['puppy','small'], mainProtein:'チキン', fiber:2.4, url:'https://hb.afl.rakuten.co.jp/ichiba/57b41c22.08fe12c0.57b41c23.755a6e9f/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fnyanzaq%2F3182550793001%2F&link_type=hybrid_url&ut=eyJwYWdlIjoiaXRlbSIsInR5cGUiOiJoeWJyaWRfdXJsIiwic2l6ZSI6IjI0MHgyNDAiLCJuYW0iOjEsIm5hbXAiOiJyaWdodCIsImNvbSI6MSwiY29tcCI6ImRvd24iLCJwcmljZSI6MSwiYm9yIjoxLCJjb2wiOjEsImJidG4iOjEsInByb2QiOjAsImFtcCI6ZmFsc2V9'},
  {name:'ヒルズ サイエンス・ダイエット パピー 小粒', maker:'Hill’s', kcal:377, protein:25, fat:15.3, priceKg:1273, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['puppy','small'], mainProtein:'チキン', kibbleSize:'小粒', url:'https://hb.afl.rakuten.co.jp/ichiba/57b41d3d.0196a071.57b41d3e.22d83eeb/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fsweet-pet%2F118630123%2F&link_type=picttext&ut=eyJwYWdlIjoiaXRlbSIsInR5cGUiOiJwaWN0dGV4dCIsInNpemUiOiIyNDB4MjQwIiwibmFtIjoxLCJuYW1wIjoicmlnaHQiLCJjb20iOjEsImNvbXAiOiJkb3duIiwicHJpY2UiOjEsImJvciI6MSwiY29sIjoxLCJiYnRuIjoxLCJwcm9kIjowLCJhbXAiOmZhbHNlfQ%3D%3D'},
  {name:'ロイヤルカナン ミディアム アダルト', maker:'Royal Canin', kcal:385, protein:23, fat:12, priceKg:1278, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['adult','medium'], mainProtein:'チキン', fiber:2.4, url:'https://hb.afl.rakuten.co.jp/ichiba/57b41e37.7d60f1c7.57b41e38.dcb0788f/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2F1096dog%2Fw-1000475-00-00%2F&link_type=picttext&ut=eyJwYWdlIjoiaXRlbSIsInR5cGUiOiJwaWN0dGV4dCIsInNpemUiOiIyNDB4MjQwIiwibmFtIjoxLCJuYW1wIjoicmlnaHQiLCJjb20iOjEsImNvbXAiOiJkb3duIiwicHJpY2UiOjEsImJvciI6MSwiY29sIjoxLCJiYnRuIjoxLCJwcm9kIjowLCJhbXAiOmZhbHNlfQ%3D%3D'},
  {name:'ロイヤルカナン ミニ ステアライズド', maker:'Royal Canin', kcal:345, protein:28, fat:11, priceKg:1746, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['neutered','small'], mainProtein:'チキン', fiber:7.6, url:'https://hb.afl.rakuten.co.jp/ichiba/57b5a3b9.ecf57661.57b5a3ba.8d1f18b9/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fdog-penet%2Ff11240%2F&link_type=picttext&ut=eyJwYWdlIjoiaXRlbSIsInR5cGUiOiJwaWN0dGV4dCIsInNpemUiOiIyNDB4MjQwIiwibmFtIjoxLCJuYW1wIjoicmlnaHQiLCJjb20iOjEsImNvbXAiOiJkb3duIiwicHJpY2UiOjEsImJvciI6MSwiY29sIjoxLCJiYnRuIjoxLCJwcm9kIjowLCJhbXAiOmZhbHNlfQ%3D%3D'},
  {name:'カナガン ドッグフード チキン 大型犬用', maker:'レティシアン', kcal:391, protein:34, fat:17, priceKg:2459, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['grainfree','palatable','protein','large'], mainProtein:'チキン', kibbleSize:'大粒', url:'https://hb.afl.rakuten.co.jp/ichiba/57d0bda8.6669781c.57d0bda9.2e11d718/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Flaetitien%2Frakuten-cdfclb-01%2F&link_type=picttext&ut=eyJwYWdlIjoiaXRlbSIsInR5cGUiOiJwaWN0dGV4dCIsInNpemUiOiIyNDB4MjQwIiwibmFtIjoxLCJuYW1wIjoicmlnaHQiLCJjb20iOjEsImNvbXAiOiJkb3duIiwicHJpY2UiOjEsImJvciI6MSwiY29sIjoxLCJiYnRuIjoxLCJwcm9kIjowLCJhbXAiOmZhbHNlfQ%3D%3D'},
  {name:'ブラバンソンヌ 大型犬・中型犬 成犬用 チキン', maker:'BRABANCONNE', kcal:346, protein:24, fat:14, priceKg:1540, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['grainfree','large','medium'], mainProtein:'チキン', url:'https://hb.afl.rakuten.co.jp/ichiba/57d0bfb1.8e204c36.57d0bfb2.847f0048/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fwepet%2F1746%2F&link_type=picttext&ut=eyJwYWdlIjoiaXRlbSIsInR5cGUiOiJwaWN0dGV4dCIsInNpemUiOiIyNDB4MjQwIiwibmFtIjoxLCJuYW1wIjoicmlnaHQiLCJjb20iOjEsImNvbXAiOiJkb3duIiwicHJpY2UiOjEsImJvciI6MSwiY29sIjoxLCJiYnRuIjoxLCJwcm9kIjowLCJhbXAiOmZhbHNlfQ%3D%3D'},
  {name:'ヒルズ サイエンス・ダイエット シニア 大型犬種用', maker:'Hill’s', kcal:363, protein:14.9, fat:11.4, priceKg:999, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['senior','large'], mainProtein:'チキン', url:'https://hb.afl.rakuten.co.jp/ichiba/57d6950a.8a7042ee.57d6950b.f4742820/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fhills-pet%2F52742015309%2F&link_type=hybrid_url&ut=eyJwYWdlIjoiaXRlbSIsInR5cGUiOiJoeWJyaWRfdXJsIiwic2l6ZSI6IjI0MHgyNDAiLCJuYW0iOjEsIm5hbXAiOiJyaWdodCIsImNvbSI6MSwiY29tcCI6ImRvd24iLCJwcmljZSI6MSwiYm9yIjoxLCJjb2wiOjEsImJidG4iOjEsInByb2QiOjAsImFtcCI6ZmFsc2V9'},
  {name:'ロイヤルカナン ミディアム ステアライズド', maker:'Royal Canin', kcal:348, protein:26, fat:11, priceKg:1848, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['neutered','medium'], mainProtein:'チキン', fiber:7.4, url:'https://hb.afl.rakuten.co.jp/ichiba/57b41d3d.0196a071.57b41d3e.22d83eeb/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fsweet-pet%2Fro0075si%2F&link_type=hybrid_url&ut=eyJwYWdlIjoiaXRlbSIsInR5cGUiOiJoeWJyaWRfdXJsIiwic2l6ZSI6IjI0MHgyNDAiLCJuYW0iOjEsIm5hbXAiOiJyaWdodCIsImNvbSI6MSwiY29tcCI6ImRvd24iLCJwcmljZSI6MSwiYm9yIjoxLCJjb2wiOjEsImJidG4iOjEsInByb2QiOjAsImFtcCI6ZmFsc2V9'},
  {name:'デビフ シニア犬の食事 ささみ＆軟骨', maker:'デビフ(d.b.f)', kcal:85, protein:9, fat:3, priceKg:1838, priceCheckedAt:'2026-09-25', priceBasis:'regular', packageSize:'', checkedAt:'2026-09-25', priceSourceUrl:'', priceNote:'', tags:['wet','senior','japan','palatable'], mainProtein:'鶏ささみ', url:'https://hb.afl.rakuten.co.jp/ichiba/57d844ca.384fc744.57d844cb.07558315/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fkenkocom%2F559007%2F&link_type=hybrid_url&ut=eyJwYWdlIjoiaXRlbSIsInR5cGUiOiJoeWJyaWRfdXJsIiwic2l6ZSI6IjI0MHgyNDAiLCJuYW0iOjEsIm5hbXAiOiJyaWdodCIsImNvbSI6MSwiY29tcCI6ImRvd24iLCJwcmljZSI6MSwiYm9yIjoxLCJjb2wiOjEsImJidG4iOjEsInByb2QiOjAsImFtcCI6ZmFsc2V9'}
]
...
const PRODUCT_SLUGS = {
  ...
  'ロイヤルカナン サイズヘルス ニュートリション ミニ パピー': 'royal-canin-mini-puppy',
  'ヒルズ サイエンス・ダイエット パピー 小粒': 'hills-puppy-small',
  'ロイヤルカナン ミディアム アダルト': 'royal-canin-medium-adult',
  'ロイヤルカナン ミニ ステアライズド': 'royal-canin-mini-sterilised',
...
function priceDisplay(f){
  const basis = f.priceBasis || (f.priceUnverified ? 'estimated' : 'regular')
  if(f.priceUnverified || basis==='estimated') return { text:'価格は販売ページで確認', note:'' }
  const basisLabel = basis==='subscription' ? '（定期便価格）' : basis==='firstTime' ? '（初回限定価格）' : ''
  const noteParts = []
  if(f.packageSize) noteParts.push(`${f.packageSize}基準`)
  if(f.checkedAt || f.priceCheckedAt) noteParts.push(`価格確認日：${f.checkedAt || f.priceCheckedAt}`)
    ...
    return `<div class="result karte res-v2">
      ...
      <div class="pdf-cta pdf-cta-main">
        <div class="pdf-cta-top">
          ...
          <div class="pdf-cta-copy"><p class="eyebrow">有料PDFで追加されること</p><h3>健診表・今のフード・おやつ量を、主治医に相談しやすいカルテへ</h3><p>無料診断は「方向性」まで。PDFカルテでは、検査値・体重・便・食べ方をまとめ、家族や病院で話しやすいメモにします。</p></div>
        </div>
      ...
      ${r.foods.length ? `<h3>${r.isPuppy ? '子犬期向けの候補フード' : '目的別の候補フード'}<span class="pr-badge">PR</span></h3><p class="pr-notice">このセクションの商品リンクにはアフィリエイト広告が含まれます。</p><p class="helper">${r.isPuppy ? '子犬用として作られた総合栄養食のみを表示しています。成長のスピードには個体差があるため、給与量はパッケージ記載の目安を優先し、気になる場合は獣医師に相談してください。' : 'ランキングではなく、上の条件に合う選択肢として表示します。健診異常・服薬・療法食がある場合は購入前に主治医へ確認してください。'}</p><div class="foods">${r.foods.map(f=>{
        const price = priceDisplay(f)
...
function renderInput(q){
  ...
  if(q.type==='labs'){
    const fieldByKey = Object.fromEntries(labFields.map(f=>[f[0], f]))
    const labInput = ([k,l,u])=>`<label><span>${l}</span><input type="number" step="0.001" data-lab="${k}" value="${(answers.labs||{})[k]||''}" placeholder="${u}"></label>`
    const renderGroupedLabs = (keys)=>LAB_GROUPS.map(([group, groupKeys])=>{
      const fields = groupKeys.filter(k=>keys.includes(k)).map(k=>fieldByKey[k]).filter(Boolean)
      return fields.length ? `<section class="lab-group"><h4>${group}</h4><div class="lab-grid">${fields.map(labInput).join('')}</div></section>` : ''
    }).join('')
    const primary = LAB_PRIMARY_KEYS.filter(k=>fieldByKey[k])
    const tracking = LAB_TRACKING_ONLY_KEYS.filter(k=>fieldByKey[k])
    return `<p class="dq-labs-title">健診結果がなくても大丈夫です</p><p class="dq-labs-sub">わかる項目だけ入力すると、より詳しく整理できます。<span class="dq-labs-optional-badge">すべて任意</span></p><p class="dq-labs-primary-label">今回の結果表示に反映する項目</p><p class="dq-labs-note">入力内容に応じて、注意点・関連記事・健診メモなどの表示に反映する項目です。</p><div class="dq-labs-grouped dq-lab-grid-primary">${renderGroupedLabs(primary)}</div><details class="dq-labs-more"><summary>＋ 記録・推移確認のための追加項目を入力する（${tracking.length}項目）</summary><p class="dq-labs-note">入力した数値は健診記録・推移確認に保存できます。現在のごはん判定には直接使用しない項目も含まれます。</p><div class="dq-labs-grouped">${renderGroupedLabs(tracking)}</div></details>`
  }
